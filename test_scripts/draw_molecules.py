...
# Save to file
img.save("/Users/imad/Desktop/Gemma4Good/sample_drug_images/drug_molecules.png")
...
# ── Step 5: Print a summary relevant to your project ──────────────
print("\n── Summary for DockExplain ──────────────────────────────────")
print("These SMILES strings are the exact input format your pipeline")
print("will accept. When a user pastes a SMILES into your Streamlit")
print("app, RDKit will parse it exactly like this code does.\n")

print("Erlotinib (your hero molecule):")
print(f"  {smiles_dict['Erlotinib']}")
print("\nNotice C#C at the start — that's the alkyne triple bond.")
print("And the Nc2ncnc3 — that's the quinazoline core that fits")
print("deep into the EGFR ATP binding pocket.\n")